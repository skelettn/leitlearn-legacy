...
<header>
    <div class="header-content">
        ...
        <p class="desc"><?=__('Découvrez la plate-forme qui permet d\'appendre efficacement gratuitement.')?></p>
        <?php if ($is_logged) : ?>
            <?= $this->Html->link(
                '<button>
...
<main>
        <div class="fixed-infos">
            <div class="text">
                ...
                <?= __('Essayez') ?> <span class="text-ia"><?= __('Leitlearn AI') ?></span> <?= __('et') ?>
                <span class="text-ia"><?= __('Créez vos paquets') ?></span>
        ...
        <section class="section-packets">
            ...
            <div class="scroll-menu">
                <div class="scroll-content">
                    ...
                    <?= $this->Html->link(__('Voir plus'), ['controller' => 'Market', 'action' => ''], ['class' => 'see-more']) ?>
                </div>
            </div>
        </section>
        <section class="section-packets">
        ...
        <section class="section-packets">
            ...
            <section class="section-feature new">
                <div class="content">
                    ...
                    <h2 class="title"><?= __('Créez vos paquets') . ' ' ?><span><?= __('avec l\'IA') ?></span></h2>
                    <p class="desc"><?= __('Générez vos flashcards puis créez votre paquet directement grâce à l\'intelligence artificielle de Leitlearn.') ?></p>
                </div>
            </section>
            <section class="section-features">
                <div class="feature">
                    ...
                    <div class="content">
                        <h3 class="title"><?= __('Parcourez notre') ?> <span class="pink"><?= __('marché') ?></span></h3>
                        <h6 class="desc">
                            <?= __('Explorez notre Marché, une fonctionnalité qui permet à nos utilisateurs de partager, d\'importer des paquets et des flashcards. Créez, échangez et découvrez une variété de ressources éducatives.') ?>
                        </h6>
                ...
                <div class="feature">
                    ...
                    <div class="content">
                        <h3 class="title"><?= __('Apprenez grâce à') . ' ' ?><span class="yellow">Leitner</span></h3>
                        <h6 class="desc">
                            <?= __('Découvrez notre mode Leitner, une approche innovante pour un apprentissage plus efficace. Notre plateforme offre un espace dédié où les utilisateurs peuvent réviser selon une répétition journalière.') ?>
                        </h6>
                ...
                <div class="feature">
                    ...
                    <div class="content">
                        <h3 class="title"><?= __('Découvrez la mise à jour') . ' '?><span class="dashed">Leitlearn 2.0</span></h3>
                        <h6 class="desc">
                            <?= __('Système d\'amis, d\'importation/d\'exportation par CSV, des flashcards musiques et images, des meilleures performances et plus encore...') ?>
                        </h6>
