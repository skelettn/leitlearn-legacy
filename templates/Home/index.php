...
<header>
    <div class="header-content">
		...
		<button>
            ...
            '/dashboard',
            ['escape' => false]
        ) ?> <?php else : ?> <button class="modal-btn" data-modal="login-modal"> <?= __('Commencer à apprendre')?> <span class="material-symbols-rounded">arrow_forward</span>
        </button> <?php endif; ?>
    </div>
...
<main>
    <div class="fixed-infos">
        <div class="text">
            ...
            <?= __('Essayez') ?>
            <span class="text-ia"> <?= __('Leitlearn AI') ?> </span>
            <?= __('et') ?>
            <span class="text-ia"> <?= __('Créez vos paquets') ?>
            </span> <?= '
				<?xml version="1.0" encoding="utf-8"?> <svg fill="#FFFFFF" width="20px" height="20px" viewBox="0 0 512 512" id="icons" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="container">
        <section class="section-packets">
            <div class="section-header">
                <h2 class="packets-title"> <?= __('Tendances')?> </h2>
            ...
            <div class="scroll-menu">
                <div class="scroll-content"> <?= $cell = $this->cell('Packets::display', ['trend']) ?> <?= $this->Html->link(__('Voir plus'), ['controller' => 'Market', 'action' => ''], ['class' => 'see-more']) ?> </div>
            </div>
        </section>
        <section class="section-packets">
            <div class="section-header">
                <h2 class="packets-title"> <?= __('Généré avec l\'IA') ?> </h2>
                <div class="scroll-buttons">
                    <button class="prev-button scroll-button">
                        <span class="material-symbols-rounded"> chevron_left </span>
                    </button>
            ...
            <div class="scroll-menu">
                <div class="scroll-content"> <?= $cell = $this->cell('Packets::display', ['ai']) ?> <?= $this->Html->link(__('Voir plus'), ['controller' => 'Market', 'action' => ''], ['class' => 'see-more']) ?> </div>
            </div>
        </section>
        <section class="section-packets">
            <div class="section-header">
                <h2 class="packets-title"> <?= __('Les plus importés') ?> </h2>
                <div class="scroll-buttons">
                    <button class="prev-button scroll-button">
                        <span class="material-symbols-rounded"> chevron_left </span>
                    </button>
            ...
            <div class="scroll-menu">
                <div class="scroll-content"> <?= $cell = $this->cell('Packets::display', ['import']) ?> <?= $this->Html->link(__('Voir plus'), ['controller' => 'Market', 'action' => ''], ['class' => 'see-more']) ?> </div>
            </div>
        </section>
        <section class="section-feature new">
            <div class="content">
                <div class="badge">Leitlearn AI</div>
                <h2 class="title"> <?= __('Créez vos paquets') . ' ' ?> <span> <?= __('avec l\'IA') ?> </span>
                </h2>
        ...
        </section> <?= $this->element('landing_footer') ?>
    </div>
</main>