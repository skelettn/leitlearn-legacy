<div class="modal" id="register-modal">
    <div class="modal-container">
        <div class="modal-header">
            <h2 class="title"><?= __('Créer un compte') ?></h2>
        ...
        <div class="modal-body">
            <div class="features">
                <div class="feature ai">
                    ...
                    <span class="content"><?= __('Utiliser Leitlearn Ai') ?></span>
                </div>
                <div class="feature">
                    <div class="icon">
                        <span class="material-symbols-rounded">
                    ...
                    <span class="content"><?= __('Créez vos paquets') ?></span>
                </div>
                <div class="feature">
                    <div class="icon">
                        <span class="material-symbols-rounded">
                    ...
                    <span class="content"><?= __('Partagez avec la communauté') ?></span>
                </div>
            </div>
            ...
            <div class="input-flex">
                <div class="input-group">
                    ...
                    <?= $this->Form->label('register-name', __('Prénom')) ?>
                </div>
                <div class="input-group">
                    <?= $this->Form->text('last_name', ['id' => 'register-lastname', 'placeholder' => '']) ?>
                    <?= $this->Form->label('register-lastname', __('Nom de famille')) ?>
                </div>
            </div>
            <div class="input-group">
            ...
            <div class="input-group">
                ...
                <?= $this->Form->label('register-password', __('Mot de passe')) ?>
            </div>
            ...
            <?= $this->Html->link(__('Vous avez déjà un compte ?'), '#', ['class' => 'modal-btn no-account', 'data-modal' => 'login-modal']) ?>
            <?= $this->Form->end() ?>
        </div>
    </div>
</div>