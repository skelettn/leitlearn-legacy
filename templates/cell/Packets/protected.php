<?php foreach ($packets as $packet): ?>
    <div class="paquet protected paquet-item page-redirect <?php echo $packet->ia ? 'ai-paquet' : ''; ?>"
    ...
    >
        ...
        <?php if ($packet->ia) : ?>
            <div class="ia-paquet-report" title="Paquet généré avec l'intelligence artificielle">
