import {createQuill} from "../utils/quill.js";
...
const initFlashcardModal = () => {
    createQuill('#editor-flashcard-front',
        '#editor-flashcard-back',
        '.input-group.front',
        '.input-group.back',
        'question',
        'answer'
    ...
    createQuill(
        '#editor-modify-flashcard-front',
        '#editor-modify-flashcard-back',
        '.input-group.front.modify',
        '.input-group.back.modify',
        'question-modify',
        'answer-modify'
    );
