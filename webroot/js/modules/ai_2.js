...
const displayResponses = (response) => {
    $.each(response, function(index, element) {
        var flashcard = createFlashcard("question", "content show", element.Question, element.Answer);
        $(".ai-flashcards").append(flashcard);
    });
}

const createFlashcard = (questionClass, answerClass, question = "", answer = "") => {
    const flashcard = $("<div>").addClass("flashcard ai-flashcard show");
